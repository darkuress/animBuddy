...
class CSlider(QtWidgets.QWidget):
    ...
    def __init__(self,  colorRGB        = [], 
        ...
        if handleText:
            ...
            self._hText         = str(self._startValue)
        self._hGeom             = [[],[]]
    ...
    def handleRect(self, value = None, position = None):
        ...
        if value != None:
            startPos = SMath.SMath.fit2RangePosInt(self._minValue, self._maxValue, 0, self._sliderWidth, value)
        elif position != None:
    ...
    def getPresetValues(self):
        ...
        for i in range(self._minValue, self._maxValue + 1, self._pStep):
            pos = SMath.SMath.fit2RangePosInt(self._minValue, self._maxValue, 10, self._sliderWidth-10, i)
    ...
    def _uiDrawHandle(self, painter):
        ...
        painter.setFont(QtGui.QFont("console", self._sliderHeight/2, weight = 75))
    ...
    def _uiDrawValueText(self, painter):
        ...
        if self._hPressed:
            ...
            self._outputValue = SMath.SMath.fit2RangeValInt(self._minValue, self._maxValue, 10, self._sliderWidth-10, self.handleCenter())
            self._printValue = self._outputValue
    ...
    def mouseMoveEvent(self, event):
        ...
        self._hText = str(self._outputValue)
